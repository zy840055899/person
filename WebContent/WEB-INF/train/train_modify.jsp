...
<body>
	...
	<!--主要区域开始-->
	<div id="main">            
	    <form action="modifyTrain.do" method="post" class="main_form" id="trainForm">
	    	<input type="hidden" value="${train.trainId }" name="trainId"/>
            <div class="text_info clearfix"><span>培训名称：</span></div>
            <div class="input_info">
                <input type="text" name="tname" value="${train.tname }" maxlength="10" />
                <span class="required">*</span>
            </div>
            
            <div class="text_info clearfix"><span>培训开始时间：</span></div>
            <div class="input_info">
            	<input class="Wdate" type="text" name="startDateStr" onClick="WdatePicker()" value="${train.startDate}">
                <span class="required">*</span>
            </div>
            
            <div class="text_info clearfix"><span>培训结束时间：</span></div>
            <div class="input_info">
            	<input class="Wdate" type="text" name="endDateStr" onClick="WdatePicker()" value="${train.endDate }">
                <span class="required">*</span>
                <div class="validate_msg_long error_msg">2到5位名称</div>
            </div>
            
            <div class="text_info clearfix"><span>培训人数：</span></div>
            <div class="input_info">
                <input type="text" name="number" maxlength="3" value="${train.number }"/>
                <span class="required">*</span>
            ...
            <div class="input_info">
                <input type="text" name="teacher" maxlength="5" value="${train.teacher }"/>
                <span class="required">*</span>
            </div>
            
            <div class="text_info clearfix"><span>备注：</span></div>
            <div class="input_info">
				<input type="text" name="descr" maxlength="30" value="${train.descr }"/>        	
                <span class="required" style="color: green;">选填</span>
            </div>
           
            <div class="button_info clearfix">
                <input type="button" value="保存" class="btn_save" onclick="modifyTrain()"/>

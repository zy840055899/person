...
<script language="javascript" type="text/javascript">
    ...
    function save() {
    	...
    	var modules = $(":checkbox[name='moduleIds']:checked");
    	if(modules.length == 0){
    		alert("至少选择一个权限");
    		return;
    	}else{
...
<%-- 	    <jsp:include page="/WEB-INF/main/menu.jsp"/> --%>
	...
	<div id="main">            
	    <form action="addRole.do" method="post" class="main_form" id="roleForm">
	            ...
	            <div class="input_info_scroll">
	                <ul>
	                	<c:forEach items="${modules}" var="m">
	                    	<li><input type="checkbox" name="moduleIds" value="${m.moduleId}"/>${m.moduleName}</li>
	                    </c:forEach>
	                </ul>
	            </div>
	            <span class="required">*</span>

...
<body>
	...
	<div id="main" style="height: 400px;">            
	    <form action="addRec.do" method="post" class="main_form" id="recruitForm">
            ...
            <div class="input_info">
                <input type="text" name="sal" maxlength="15" />
                <span class="required">*</span>
            </div>
            ...
            <div class="button_info clearfix">
                <input type="button" value="保存" class="btn_save" onclick="addRecruit()"/>
